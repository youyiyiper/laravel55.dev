            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">新增管理员</h4>
                    </div>
                    @include('layouts.flash')
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/admin') }}" method="POST">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="email">邮箱 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="email" placeholder="邮箱（将会作为登录名）" value="{{ old('email') }}" data-parsley-required="true" data-parsley-required-message="请输入邮箱" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="name">姓名 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="name" placeholder="姓名" value="{{ old('name') }}" data-parsley-length="[2,20]" data-parsley-length-message="姓名长度2~20字符" data-parsley-required="true" data-parsley-required-message="请输入姓名"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="role_id">选择角色 * :</label>
                                <div class="col-md-4 col-sm-4">
