...
<body>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown navbar-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ asset(!empty(session('adminDetail.headimg')) ? session('adminDetail.headimg') : 'asset_admin/assets/img/user-1.jpg') }}" alt="" />
                            <span class="hidden-xs">{{ session('adminDetail.name') }}</span> <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu animated fadeInLeft">
                            <li class="arrow"></li>
                            <li><a href="{{url('admin/manager/setting')}}">个人中心</a></li>
                            <li><a href="javascript:;"><span class="badge badge-danger pull-right">2</span> Inbox</a></li>
                            <li><a href="javascript:;">Calendar</a></li>
                            <li><a href="{{url('admin/manager/changePwd')}}">修改密码</a></li>
                            <li class="divider"></li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('div .alert-success,div .alert-info').delay(3000).slideUp(300);
        });
    </script>
</body>
</html>